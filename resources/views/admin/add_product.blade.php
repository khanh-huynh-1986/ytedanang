                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" data-validation="length" data-validation-length="max30" data-validation-error-msg="Làm ơn điền ít hơn 30 ký tự" name="product_name" class="form-control" id="exampleInputEmail1" placeholder="Tên danh mục">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">SL sản phẩm đã bán mặc định 0</label>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Slug-link sp không được giống nhau</label>
